...
const Relatedproducts = () => {
  return (
    <div className='flex flex-col items-center gap-[10px] h-auto md:h-[90vh] py-[40px] md:py-0 px-4'>
        <h1 className='text-[#171717] text-2xl sm:text-3xl md:text-5xl font-semibold text-center'>Related products</h1>
        <hr className='w-[150px] md:w-[200px] h-[6px] rounded-2xl bg-[#252525]' />
